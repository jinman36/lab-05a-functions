...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  return [sumTotal, multiplyTotal, message1, message2];
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let messageArray = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${arraySumTotal} is their sum.`;
...
//   let arrayMultiplyOne = multiply(multArr[0], multArr[1])[0];
//   let arrayMultiplyTotal = multiply(arrayMultiplyOne, multArr[2])[0];
//   // console.log(arrayMultiplyOne);
//   // console.log(arrayMultiplyTotal);
//   let messageMultArray = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${arrayMultiplyTotal}.`;
//   return [arrayMultiplyTotal, messageMultArray];
// }
//////////End of working code
...
// testDynamicArray.reduce(multiplyAnyArray);
